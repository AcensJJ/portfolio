<section class="info">
	<div class="col-sm-7 mx-auto fade-in">
  	  ...
  	  <div id="left-zone">
      	<ul class="list fade-in">
			...
			<li class="item">
				...
				<label class="label_testimonial-2" for="radio_testimonial-2">Mes projets</label>
			...
			<label class="label_testimonial-3" for="radio_testimonial-3">Actu</label>
			...
			<label class="label_testimonial-4" for="radio_testimonial-4">Contact</label>
